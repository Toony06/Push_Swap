...
#    Updated: 2025/04/03 10:48:03 by toroman          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS = main.c parsing.c utils1.c initialise_node.c big_sort.c little_sort.c swap_stack.c rotate_stack.c rotate_reverse.c push_stack.c utils2.c utils3.c
OBJS = ${SRCS:.c=.o}
NAME = push_swap
CC = gcc
